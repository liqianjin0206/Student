...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(".pagination li:first").click(function() {
		    var name=$("#name").val();
			if (ye > 1) {
			location.href = "sub?type=search&ye="+ (ye - 1)+"&name="+name;
			}
		});
		...
		$("[name=qwe]").click(function() {
			...
			alert(name);
			ye = $(this).html();
			location.href = "sub?type=search&ye=" + ye+"&name="+name;

		});
		$(".add").click(function() {
			location.href = "sub?type=showAdd";
		})
		...
		$(".modify").click(function() {
			if (id == null) {
				...
				location.href = "sub?id=" + id + "&type=showModify";
			}
		...
		$(".delete").click(function() {
			...
			if (array.length == 0) {
				...
				if (type) {
					location.href = "sub?type=delete&id=" + array;
				}
			}
			//alert($(".color").length);
